...
(_a = document
    ...
    var resumeOutput = "\n    <h2>Resume</h2>\n    ".concat(((_a = profilePictureInput.files) === null || _a === void 0 ? void 0 : _a[0])
        ? "<img src=\"".concat(URL.createObjectURL(profilePictureInput.files[0]), "\" alt=\"Profile Pic\" class=\"profilePicture\">")
